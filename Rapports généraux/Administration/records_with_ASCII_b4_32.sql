...
Identifie les notices avec des caractères ASCII avant 32 (control characters) dans les titres, auteurs ou cotes (j'ai pas de cas dans les cotes, donc je ne sais pas si ça fonctionne)
